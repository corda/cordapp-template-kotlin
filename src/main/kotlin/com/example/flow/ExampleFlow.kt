...
object ExampleFlow {
    class Initiator(val po: DealState,
                    ...
                    override val progressTracker: ProgressTracker = Initiator.tracker()): FlowLogic<SignedTransaction>() {
        /**
    ...
    class Acceptor(val otherParty: Party,
                   override val progressTracker: ProgressTracker = Acceptor.tracker()): FlowLogic<SignedTransaction>() {
        companion object {
